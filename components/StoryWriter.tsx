 ...
 const storiesPath = "/stories";
   ...
   async function runScript() {
    ...
    if (response.ok && response.body) {
      ...
      //..
      console.log("Streaming had started");
      ...
      setRunFinished(true);
      setRunStarted(false);
      console.log("An error occured while generating the story. Please try again later  "); 
    }
   ...
   async function handleStream(reader: ReadableStreamDefaultReader<Uint8Array>, decoder: TextDecoder) {
    ...
    while(true) {
      ...
      //we split the chunks into evens by splitting it by the event: keyword.
  ...
  return (
    <div className='flex flex-col container'>
        ...
        <section  className='flex-1 flex flex-col border border-purple-300 rounded-md p-10 space-y-2'>
          ...
          <Button disabled={!story || !pages || runStarted} className='w-full bg-black' size="lg"
          onClick={runScript}
          >
            Generate Story
          </Button>
        ...
        <section className='flex-1 pb-5 mt-5'>
          <div className='flex flex-col-reverse w-full space-y-2 bg-gray-800 rounded-md text-gray-200 font font-mono p-10 h-96 overflow-y-auto'>
